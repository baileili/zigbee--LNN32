...
{
if(baudrate==0){Serial.print("2400");return 2400;}
else if(baudrate==1){Serial.print("4800");return 2400;}
else if(baudrate==2){Serial.print("9600");return 9600;}
else if(baudrate==3){Serial.print("14400");return 14400;}
else if(baudrate==4){Serial.print("19200");return 19200;}
else if(baudrate==5){Serial.print("28800");return 28800;}
else if(baudrate==6){Serial.print("38400");return 38400;}
else if(baudrate==7){Serial.print("57600");return 57600;}
else if(baudrate==8){Serial.print("115200");return 115200;}
else if(baudrate==9){Serial.print("230400");return 230400;}
else if(baudrate==10){Serial.print("125000");return 125000;}
else if(baudrate==11){Serial.print("250000");return 250000;}
else if(baudrate==12){Serial.print("500000");return 500000;}
